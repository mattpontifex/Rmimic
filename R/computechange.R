...
#'        "Time" = c(rep_len("Time1",20),rep_len("Time2",20),
#'        rep_len("Time3",20)), "X" = runif(60))
#'     mockdatabase <- computechange(mockdatabase, 
#'        dependentvariable='X', subjectid='ID', within='Time')
#'
#' @export
